...
namespace Hourly.Tests.Data.Utilities
{
    internal class TestDatabaseSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            var workSessionGitCommits = WorkSessionGitCommitFactory.CreateWorkSessionGitCommits(workSessionIds, gitCommitIds);
            ...
            context.WorkSessionGitCommits.AddRange(workSessionGitCommits);
